...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/iam/master/_listings/aws-rds/apis.md
...
- name: AWS RDS API - Add Role To D B Cluster
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/iam/master/_listings/aws-rds/actionaddroletodbcluster-get-openapi.md
- name: AWS RDS API - Remove Role From D B Cluster
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/iam/master/_listings/aws-rds/actionremoverolefromdbcluster-get-openapi.md
x-common:
- type: x-api-gallery
